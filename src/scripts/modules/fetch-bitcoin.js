...
export default function fetchBitcoin(url, target) {
  // O fetch faz a requisição para a URL da api e quando tiver o status de ok(carregado com sucesso) o then executa.
  fetch(url)
    ...
    .then((bitcoin) => {
      const btc = document.querySelector(target); // Está puxando do DOM o primeiro elemento que contém a classe btc-preco e armazenando na constante btc.
